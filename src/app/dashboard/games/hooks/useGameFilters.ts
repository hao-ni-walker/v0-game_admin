...
export function useGameFilters() {
  ...
  useEffect(() => {
    ...
    const urlFilters: GameFilters = {
      ...
      provider_codes: provider_codes ? provider_codes.split(',') : [],
      categories: categories ? categories.split(',') : [],
      lang: searchParams.get('lang') || '',
      status: searchParams.get('status') === 'all' ? 'all' : searchParams.get('status') === 'true' ? true : searchParams.get('status') === 'false' ? false : 'all',
      is_new: searchParams.get('is_new') === 'true' ? true : undefined,
      is_featured: searchParams.get('is_featured') === 'true' ? true : undefined,
      is_mobile_supported: searchParams.get('is_mobile_supported') === 'true' ? true : undefined,
      is_demo_available: searchParams.get('is_demo_available') === 'true' ? true : undefined,
      has_jackpot: searchParams.get('has_jackpot') === 'true' ? true : undefined,
