...
import { PlatformFilters as PlatformFiltersType } from '../types';
import { SORT_OPTIONS, DEFAULT_FILTERS } from '../constants';

interface PlatformFiltersProps {
  filters: PlatformFiltersType;
  onSearch: (filters: Partial<PlatformFiltersType>) => void;
  onReset: () => void;
  loading?: boolean;
}
...
export function PlatformFilters({
  ...
  const [localFilters, setLocalFilters] =
    useState<PlatformFiltersType>(filters);
  ...
  // 更新本地筛选条件
  const updateLocalFilter = (key: keyof PlatformFiltersType, value: any) => {
